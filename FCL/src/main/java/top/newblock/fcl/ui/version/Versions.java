package top.newblock.fcl.ui.version;
...
import top.newblock.fcl.game.LauncherHelper;
...
import top.newblock.fcl.ui.account.CreateAccountDialog;
import top.newblock.fcl.ui.download.DownloadPageManager;
import top.newblock.fcl.ui.download.modpack.LocalModpackPage;
import top.newblock.fcl.ui.download.modpack.ModpackSelectionPage;
import top.newblock.fcl.ui.manage.ManagePageManager;
import top.newblock.fcl.ui.manage.ModpackTypeSelectionPage;
...
public class Versions {
    ...
    private static boolean checkVersionForLaunching(Context context, Profile profile, String id) {
        if (id == null || !profile.getRepository().isLoaded() || !profile.getRepository().hasVersion(id)) {
            ...
            builder.setNegativeButton(context.getString(top.newblock.fcl.R.string.dialog_positive), () -> {
