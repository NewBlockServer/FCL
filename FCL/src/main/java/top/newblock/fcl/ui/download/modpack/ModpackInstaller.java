package top.newblock.fcl.ui.download.modpack;
...
import top.newblock.fcl.game.ManuallyCreatedModpackException;
...
import top.newblock.fcl.ui.download.version.VersionInstallInfoPage;
                ...
                public void onStop(boolean success, TaskExecutor executor) {
                    Schedulers.androidUIThread().execute(() -> {
                        if (success) {
                            ...
                            builder1.setNegativeButton(context.getString(top.newblock.fcl.R.string.dialog_positive), () -> {
                                if (update) {
