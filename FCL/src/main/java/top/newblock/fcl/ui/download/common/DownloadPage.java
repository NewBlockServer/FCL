package top.newblock.fcl.ui.download.common;

import static top.newblock.fcl.ui.download.DownloadPageManager.PAGE_ID_DOWNLOAD_MOD;
import static top.newblock.fcl.ui.download.DownloadPageManager.PAGE_ID_DOWNLOAD_MODPACK;
import static top.newblock.fcl.ui.download.DownloadPageManager.PAGE_ID_DOWNLOAD_RESOURCE_PACK;
import static top.newblock.fcl.ui.download.DownloadPageManager.PAGE_ID_DOWNLOAD_SHADER_PACK;
...
import top.newblock.fcl.databinding.PageDownloadBinding;
import top.newblock.fcl.setting.DownloadProviders;
import top.newblock.fcl.setting.Profile;
import top.newblock.fcl.ui.PageManager;
import top.newblock.fcl.ui.TaskDialog;
import top.newblock.fcl.ui.download.DownloadPageManager;
import top.newblock.fcl.ui.download.ModDownloadPage;
import top.newblock.fcl.ui.download.TranslationDialog;
                ...
                TaskExecutor executor = Task.composeAsync(() -> {
                    ...
                    if (exception != null) {
                        if (exception instanceof CancellationException) {
                            ...
                            builder.setNegativeButton(context.getString(top.newblock.fcl.R.string.dialog_positive), null);
                            builder.create().show();
                        }
                    } else {
