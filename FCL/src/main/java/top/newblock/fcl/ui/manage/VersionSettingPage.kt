...
import top.newblock.fcl.activity.MainActivity.Companion.getInstance
import top.newblock.fcl.control.SelectControllerDialog
import top.newblock.fcl.databinding.PageVersionSettingBinding
import top.newblock.fcl.game.FCLGameRepository
import top.newblock.fcl.setting.Controllers
import top.newblock.fcl.setting.Profile
import top.newblock.fcl.setting.Profiles.getSelectedProfile
import top.newblock.fcl.setting.VersionSetting
import top.newblock.fcl.ui.controller.ControllerPageManager
import top.newblock.fcl.ui.manage.ManageUI.VersionLoadable
        ...
        binding.switchVulkanDriverSystem.setOnClickListener {
            if (binding.switchVulkanDriverSystem.checkProperty()
                ...
                builder.setNegativeButton(
                    context.getString(top.newblock.fcl.R.string.dialog_positive),
                    null
                )
                builder.create().show()
            }
