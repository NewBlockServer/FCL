...
import static top.newblock.fcl.util.FXUtils.onInvalidating;
...
import top.newblock.fcl.activity.ControllerActivity;
...
import top.newblock.fcl.util.LayoutConverter;
...
public class ControllerManagePage extends FCLCommonPage implements View.OnClickListener {
    ...
    private void shareFile(File file, int chooserTitleRes, String mimeType) {
        ...
        Uri uri = FileProvider.getUriForFile(getContext(), getContext().getString(top.newblock.fcl.R.string.file_browser_provider), file);
