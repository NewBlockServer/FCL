package top.newblock.fcl.ui.manage;

import static top.newblock.fcl.ui.download.version.VersionInstallInfoPage.alertFailureMessage;
        ...
        CompletableFuture.supplyAsync(() -> {
            ...
            for (InstallerItem installerItem : group.getLibraries()) {
                ...
                installerItem.action.set(() -> {
                    top.newblock.fcl.ui.download.version.InstallerListPage page = new top.newblock.fcl.ui.download.version.InstallerListPage(getContext(), PageManager.PAGE_ID_TEMP, getParent(), R.layout.page_install_version, gameVersion, libraryId, remoteVersion -> {
            ...
            public void onStop(boolean success, TaskExecutor executor) {
                Schedulers.androidUIThread().execute(() -> {
                    if (success) {
                        ...
                        builder.setNegativeButton(getContext().getString(top.newblock.fcl.R.string.dialog_positive), () -> profile.getRepository().onVersionIconChanged.fireEvent(new Event(this)));
                        builder.create().show();
                    } else {
                ...
                public void onStop(boolean success, TaskExecutor executor) {
                    Schedulers.androidUIThread().execute(() -> {
                        if (success) {
                            ...
                            builder1.setNegativeButton(getContext().getString(top.newblock.fcl.R.string.dialog_positive), () -> {
