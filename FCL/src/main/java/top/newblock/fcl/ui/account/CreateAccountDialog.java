package top.newblock.fcl.ui.account;

import static top.newblock.fcl.setting.Accounts.FACTORY_AUTHLIB_INJECTOR;
import static top.newblock.fcl.setting.Accounts.FACTORY_MICROSOFT;
import static top.newblock.fcl.setting.Accounts.FACTORY_OFFLINE;
import static top.newblock.fcl.setting.ConfigHolder.config;
...
import top.newblock.fcl.game.OAuthServer;
                    ...
                    .whenComplete(Schedulers.androidUIThread(), account -> {
                        ...
                        if (exception instanceof NoSelectedCharacterException || exception instanceof CancellationException) {
                            ...
                            new FCLAlertDialog.Builder(getContext())
                                    ...
                                    .setCancelable(false)
                                    .setNegativeButton(getContext().getString(top.newblock.fcl.R.string.dialog_positive), null)
                                    .useAutoLink()
                                    .create()
                                    .show();
                        }
