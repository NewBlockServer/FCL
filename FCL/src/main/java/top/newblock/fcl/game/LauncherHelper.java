 ...
 */
package top.newblock.fcl.game;

import static android.content.Context.MODE_PRIVATE;
import static top.newblock.fcl.util.AndroidUtils.getLocalizedText;
import static top.newblock.fcl.util.AndroidUtils.hasStringId;
...
import top.newblock.fcl.FCLApplication;
import top.newblock.fcl.R;
import top.newblock.fcl.activity.JVMActivity;
import top.newblock.fcl.activity.MainActivity;
import top.newblock.fcl.control.MenuType;
...
import top.newblock.fcl.setting.VersionSetting;
        ...
        TaskExecutor executor = checkGameState(context, setting, version.get())
                ...
                .thenComposeAsync(authInfo -> Task.supplyAsync(() -> {
                        ...
                        .thenComposeAsync(fclBridge -> {
                            Renderer renderer = RendererManager.getRenderer("com.fcl.plugin.mobileglues");
            ...
            if (setting.getJava().equals("Auto")) {
                if (isCleanroom) {
                    if (cleanroomVersion != null && cleanroomVersion.compareTo("0.5.0") >= 0) {
                        ...
                        return JavaManager.getJavaFromVersionName("jre25");
                    }
                } else {
        ...
        return task.thenComposeAsync(Schedulers.androidUIThread(), javaVersion -> {
            ...
            if (isCleanroom) {
                if (cleanroomVersion != null && cleanroomVersion.compareTo("0.5.0") >= 0) {
                    ...
                    suggestedJavaVersion = JavaManager.getJavaFromVersionName("jre25");
                }
            } else {
