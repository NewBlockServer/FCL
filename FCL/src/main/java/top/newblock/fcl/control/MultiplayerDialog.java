...
import top.newblock.fcl.terracotta.Terracotta;
import top.newblock.fcl.terracotta.TerracottaNodeList;
import top.newblock.fcl.terracotta.TerracottaState;
import top.newblock.fcl.terracotta.profile.TerracottaProfile;
            ...
            ((FCLImageView) findViewById(R.id.difficulty_icon)).imageProperty().bind(Bindings.createObjectBinding(() -> {
                if (Terracotta.stateProperty().get() instanceof TerracottaState.GuestStarting &&
                    ...
                    if (((TerracottaState.GuestStarting) Terracotta.stateProperty().get()).getDifficulty() == TerracottaState.GuestStarting.Difficulty.EASIEST ||
                        ...
                        return AppCompatResources.getDrawable(context, top.newblock.fcl.R.drawable.ic_baseline_info_24);
                return AppCompatResources.getDrawable(context, top.newblock.fcl.R.drawable.ic_baseline_warning_24);
            }, Terracotta.stateProperty()));
