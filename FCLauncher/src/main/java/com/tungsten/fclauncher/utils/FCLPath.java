...
public class FCLPath {
    ...
    public static String SHARED_COMMON_DIR = Environment.getExternalStorageDirectory().getAbsolutePath() + "/FCL-NewBlockClient/.minecraft";
    ...
    public static void loadPaths(Context context) {
        ...
        LOG_DIR = Environment.getExternalStorageDirectory().getAbsolutePath() + "/FCL-NewBlockClient/log";
        ...
        CONTROLLER_DIR = Environment.getExternalStorageDirectory().getAbsolutePath() + "/FCL-NewBlockClient/control";
        SHARE_DIR = Environment.getExternalStorageDirectory().getAbsolutePath() + "/FCL-NewBlockClient/share";
